...
getCountriesByBrand(){
  ...
  onSubmit() {
    ...
    // if (this.addFilterForm.value.store_link_ar != ""){
     
    //   //const a = /^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)?[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/g;
    //   const a = /^(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})?$/g;
    //   let is_match = this.addFilterForm.value.store_link_ar.match(a);
 
    //  if (is_match == null){
    //    alert("Enter valid store link In Arabic")
    //    return
    //  }
    ...
    // if (this.addFilterForm.value.video_link_ar != ""){
    ...
    //   let is_match = this.addFilterForm.value.video_link_ar.match(a);
 
    //  if (is_match == null){
    //    alert("Enter valid video link In Arabic")
    //    return
    //  }
